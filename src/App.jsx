...
function Landing() {
  return <div>
    <header className="site-header">
      <Link to="/" className="brand"><span className="brand-mark"><CircleDollarSign size={19}/></span>CobrançaPro</Link>
...
function AuthLayout({children,title,subtitle}) {
  return <div className="auth-page"><div className="auth-card"><Link to="/" className="brand auth-brand"><span className="brand-mark"><CircleDollarSign size={19}/></span>CobrançaPro</Link><div className="auth-heading"><h1>{title}</h1><p>{subtitle}</p></div>{children}</div></div>
}
